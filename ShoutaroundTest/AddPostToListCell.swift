...
class AddPostToListCell: UITableViewCell, EmojiButtonArrayDelegate {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        listnameLabel.anchor(top: listIndLabel.topAnchor, left: listIndLabel.rightAnchor, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 25, paddingBottom: 0, paddingRight: 10, width: 0, height: 0)
