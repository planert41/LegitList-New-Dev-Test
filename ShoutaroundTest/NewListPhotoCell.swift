...
class NewListPhotoCell: UICollectionViewCell, UIGestureRecognizerDelegate, UIScrollViewDelegate, EmojiButtonArrayDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
...
//            setupAttributedSocialCount()
    ...
    let locationNameLabel: UILabel = {
        let label = UILabel()
        label.text = "Location"
        label.font = UIFont(font: .verdanaBold, size: 16)
...
//        self.likeButton.setImage(((post?.hasLiked)! ? legit_img.withRenderingMode(.alwaysOriginal) : legit_img), for: .normal)
    ...
    override init(frame: CGRect) {
        ...
        photoImageScrollView.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: nil, paddingTop: 1, paddingLeft: 1, paddingBottom: 1, paddingRight: 0, width: 0, height: 0)
    ...
    // ADD STAR RATING
        ...
        starRating.anchor(top: nil, left: photoImageScrollView.leftAnchor, bottom: photoImageScrollView.bottomAnchor, right: nil, paddingTop: 3, paddingLeft: 5, paddingBottom: 5, paddingRight: 5, width: 0, height: 0)
//        starRating.centerYAnchor.constraint(equalTo: userProfileImageView.centerYAnchor).isActive = true
    ...
    // ADD EMOJIS
        ...
        emojiArray.anchor(top: nil, left: starRating.rightAnchor, bottom: photoImageScrollView.bottomAnchor, right: photoImageScrollView.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 5, paddingRight: 5, width: 0, height: 15)
        emojiArray.delegate = self
        emojiArray.alignment = .right
        
        
        addSubview(emojiDetailLabel)
        emojiDetailLabel.anchor(top: photoImageScrollView.topAnchor, left: photoImageScrollView.leftAnchor, bottom: nil, right: photoImageScrollView.rightAnchor, paddingTop: 5, paddingLeft: 5, paddingBottom: 0, paddingRight: 5, width: 0, height: 25)
        ...
        cancelPostButton.anchor(top: photoImageScrollView.topAnchor, left: nil, bottom: nil, right: rightAnchor, paddingTop: 5, paddingLeft: 0, paddingBottom: 0, paddingRight: 5, width: 0, height: 0)
        cancelPostButton.heightAnchor.constraint(equalTo: cancelPostButton.widthAnchor).isActive = true
        cancelButtonWidthConstraint = cancelPostButton.widthAnchor.constraint(equalToConstant: 0)
        cancelButtonWidthConstraint?.isActive = !self.showCancelButton
        
        
        // Location Data
        addSubview(locationNameLabel)
        locationNameLabel.anchor(top: photoImageScrollView.topAnchor, left: photoImageScrollView.rightAnchor, bottom: nil, right: cancelPostButton.leftAnchor, paddingTop: 5, paddingLeft: 10, paddingBottom: 0, paddingRight: 10, width: 0, height: 0)
        locationNameLabel.heightAnchor.constraint(lessThanOrEqualToConstant: 40).isActive = true
        locationNameLabel.heightAnchor.constraint(greaterThanOrEqualToConstant: 20).isActive = true
//        locationNameLabel.rightAnchor.constraint(equalTo: showCancelButton ? cancelPostButton.leftAnchor : rightAnchor)

//        locationNameLabel.rightAnchor.constraint(lessThanOrEqualTo: rightAnchor).isActive = true
        
        
//        addSubview(ratingEmojiLabel)
//        ratingEmojiLabel.anchor(top: nil, left: locationNameLabel.rightAnchor, bottom: nil, right: nil, paddingTop: 0, paddingLeft: 5, paddingBottom: 0, paddingRight: 0, width: 25, height: 25)
//        ratingEmojiLabel.centerYAnchor.constraint(equalTo: locationNameLabel.centerYAnchor).isActive = true
        
        let userView = UIView()
        addSubview(userView)
        userView.anchor(top: locationNameLabel.bottomAnchor, left: photoImageScrollView.rightAnchor, bottom: nil, right: rightAnchor, paddingTop: 5, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: userProfileImageHeight)
        
        // Add User Profile Image
        addSubview(userProfileImageView)
        userProfileImageView.anchor(top: userView.topAnchor, left: userView.leftAnchor, bottom: userView.bottomAnchor, right: nil, paddingTop: 0, paddingLeft: 10, paddingBottom: 0, paddingRight: 0, width: userProfileImageHeight, height: userProfileImageHeight)
...
//        //     Add Star Rating
//        addSubview(starRating)
//        starRating.anchor(top: nil, left: userProfileImageView.rightAnchor, bottom: nil, right: nil, paddingTop: 3, paddingLeft: 10, paddingBottom: 0, paddingRight: 5, width: 0, height: 0)
//        starRating.centerYAnchor.constraint(equalTo: userProfileImageView.centerYAnchor).isActive = true
//        hideStarRatingWidth = starRating.heightAnchor.constraint(equalToConstant: 0)
        ...
        distanceLabel.anchor(top: nil, left: nil, bottom: nil, right: rightAnchor, paddingTop: 3, paddingLeft: 0, paddingBottom: 0, paddingRight: 5, width: 0, height: 0)
        distanceLabel.centerYAnchor.constraint(equalTo: userView.centerYAnchor).isActive = true
        distanceLabel.sizeToFit()
        ...
        dateLabel.anchor(top: nil, left: nil, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 3, paddingRight: 5, width: 0, height: 0)
        dateLabel.sizeToFit()
        
        // DATE DETAIL VIEW
        addSubview(detailView)
        detailView.anchor(top: nil, left: photoImageScrollView.rightAnchor, bottom: dateLabel.topAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 1, paddingRight: 25, width: 0, height: 25)
        setupSocialAndDateViews()
        
        
        // LIST COLLECTION VIEW
        addSubview(listCollectionView)
        listCollectionView.anchor(top: nil, left: photoImageScrollView.rightAnchor, bottom: detailView.topAnchor, right: rightAnchor, paddingTop: 3, paddingLeft: 10, paddingBottom: 3, paddingRight: 5, width: 0, height: 30)
        hideListCollectionViewHeight = listCollectionView.heightAnchor.constraint(equalToConstant: 0)
        setupListCollectionView()

        // CAPTION
        addSubview(captionLabel)
        captionLabel.anchor(top: userView.bottomAnchor, left: photoImageScrollView.rightAnchor, bottom: nil, right: rightAnchor, paddingTop: 5, paddingLeft: 10, paddingBottom: 5, paddingRight: 5, width: 0, height: 0)
        captionLabel.bottomAnchor.constraint(lessThanOrEqualTo: listCollectionView.topAnchor).isActive = true
