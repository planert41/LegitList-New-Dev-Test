...
protocol UserAndListCellDelegate {
...
class UserAndListCell: UITableViewCell, EmojiButtonArrayDelegate {
    ...
    var delegate: UserAndListCellDelegate?
    var cellType: String?
...
//            self.profileImageView.backgroundColor = UIColor.backgroundGrayColor()
        ...
        let listnameString = NSMutableAttributedString(string: " \((self.list?.name)!)", attributes: [NSAttributedString.Key.foregroundColor: UIColor.black, NSAttributedString.Key.font: UIFont(font: .helveticaNeueBold, size: 18)])
...
//        }
    ...
    func setupListUserName() {
        ...
        let socialFont = UIFont.boldSystemFont(ofSize: 14)
        if let username = self.listUser?.username {
            let listUserString = NSMutableAttributedString(string: "\(username) ", attributes: [NSAttributedString.Key.foregroundColor: UIColor.darkGray, NSAttributedString.Key.font: socialFont])
...
//        }
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        profileImageView.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: nil, paddingTop: 10, paddingLeft: 8, paddingBottom: 10, paddingRight: 0, width: 60, height: 0)
...
//        followButton.anchor(top: topAnchor, left: nil, bottom: bottomAnchor, right: rightAnchor, paddingTop: 20, paddingLeft: 0, paddingBottom: 20, paddingRight: 5, width: 100, height: 0)
        followButton.anchor(top: nil, left: nil, bottom: nil, right: rightAnchor, paddingTop: 20, paddingLeft: 0, paddingBottom: 20, paddingRight: 10, width: 100, height: 0)
        followButton.centerYAnchor.constraint(equalTo: centerYAnchor).isActive = true
        followButton.isHidden = true

        
        cellView.addSubview(headerLabel)
        headerLabel.anchor(top: profileImageView.topAnchor, left: profileImageView.rightAnchor, bottom: nil, right: followButton.leftAnchor, paddingTop: 0, paddingLeft: 10, paddingBottom: 0, paddingRight: 10, width: 0, height: 0)
...
//        emojiLabel.centerYAnchor.constraint(equalTo: self.centerYAnchor).isActive = true
        ...
        altTextLabel.anchor(top: nil, left: nil, bottom: nil, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 15, width: 0, height: 0)
        ...
        subHeaderLabel.anchor(top: headerLabel.bottomAnchor, left: profileImageView.rightAnchor, bottom: nil, right: nil, paddingTop: 1, paddingLeft: 10, paddingBottom: 0, paddingRight: 10, width: 0, height: 0)
        ...
        socialStatsLabel.anchor(top: subHeaderLabel.bottomAnchor, left: profileImageView.rightAnchor, bottom: nil, right: followButton.leftAnchor, paddingTop: 1, paddingLeft: 10, paddingBottom: 0, paddingRight: 10, width: 0, height: 0)
