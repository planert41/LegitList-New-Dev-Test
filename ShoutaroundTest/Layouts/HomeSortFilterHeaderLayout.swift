...
//            print("Set Init Offset, OffsetY \(contentOffsetY), InitOffset: \(self.initContentYOffset)")
        ...
        let headerfloor = max(0,contentOffsetY - self.initContentYOffset! - (headerHeightConstant ?? 0.0))
...
//        print("Offsety : ", contentOffsetY, "Prior Offset: ", self.priorOffsetY!, "Header Postion ", headerOffset, "floor: ", headerfloor, "ceiling: ", headerceiling, "init offset: ",self.initContentYOffset! , "HeaderHeight :", headerHeightConstant)
