...
//
//
//class GoogleMapViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, GMSMapViewDelegate, ListPhotoCellDelegate, GridPhotoCellDelegate, ListHeaderDelegate, FilterControllerDelegate, UINavigationControllerDelegate {
...
//        didSet{
//            print("Current Display List Updated \(currentDisplayList?.name)")
////            selectedPostID = nil
//            fetchPostsForList()
//        }
//    }
...
//            }
//
//            // Default First Selected Post. Selects a new post after sorting
////            self.selectedPostID = self.selectedPostID == nil ? self.fetchedPosts[0].id : self.selectedPostID
////            print("Fetched Posts: Default Selected Post: \(self.fetchedPosts[0].locationName) \(self.fetchedPosts[0].locationGPS)")
//
