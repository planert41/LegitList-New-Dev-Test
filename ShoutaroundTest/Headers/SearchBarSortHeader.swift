...
protocol SearchBarSortHeaderDelegate {
...
class SearchBarSortHeader: UICollectionViewCell, UISearchBarDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    
    var delegate: SearchBarSortHeaderDelegate?
...
//        searchBarView.backgroundColor = UIColor.legitColor()
        ...
        sortButton.anchor(top: searchBarView.topAnchor, left: nil, bottom: searchBarView.bottomAnchor, right: searchBarView.rightAnchor, paddingTop: 5, paddingLeft: 0, paddingBottom: 5, paddingRight: 10, width: 0, height: 0)
        setupSortPicker()
