...
protocol FriendFilterHeaderDelegate {
    ...
    func openFilter()
//    func friendSortSelected(sort: String)
//    func openMap()
}

class FriendFilterHeader: UICollectionViewCell, UISearchBarDelegate {
    
    var delegate: FriendFilterHeaderDelegate?
...
//            }
    ...
    var sortOptions: [String] = FriendSortOptions {
        didSet{
            self.updateSegments()
        }
    }
    ...
    var selectedSort: String = FriendSortDefault {
        didSet{
...
//    }
    ...
    override init(frame: CGRect) {
        ...
        searchBarView.anchor(top: nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 40)
        ...
        filterButton.anchor(top: nil, left: nil, bottom: nil, right: searchBarView.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 5, width: 30, height: 30)
        ...
        defaultSearchBar.anchor(top: searchBarView.topAnchor, left: searchBarView.leftAnchor, bottom: searchBarView.bottomAnchor, right: filterButton.leftAnchor, paddingTop: 5, paddingLeft: 5, paddingBottom: 5, paddingRight: 5, width: 0, height: 0)
        ...
        if let index = FriendSortOptions.firstIndex(of: self.selectedSort) {
            headerSortSegment.selectedSegmentIndex = index
        } else {
            headerSortSegment.selectedSegmentIndex = 0
        }
        ...
        headerSortSegment.anchor(top: topAnchor, left: leftAnchor, bottom: searchBarView.topAnchor, right: rightAnchor, paddingTop: 3, paddingLeft: 20, paddingBottom: 2, paddingRight: 20, width: 0, height: 0)
...
//        delegate?.friendSortSelected(sort: self.selectedSort)
        print("Selected Friend Sort is ",self.selectedSort)
    }
