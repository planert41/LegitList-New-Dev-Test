...
class NewUserOnboardingView2: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, BounceSelectCellDelegate, DiscoverListViewDelegate {
    ...
    let friendsLabel: UILabel = {
        ...
        label.text = "Friend-source food recommendations customized to your unique taste buds"
    ...
    let friendsLabel2: UILabel = {
        ...
        label.font = UIFont(font: .avenirNextDemiBold, size: 22)
        //        label.text = "Recommended by you & your friends anywhere you are"
        label.text = "Share a food brain 🧠 with the people you trust when you use your feed and lists"
        label.textColor = UIColor.ianBlackColor()
        label.numberOfLines = 0
        label.lineBreakMode = NSLineBreakMode.byWordWrapping
        return label
    ...
    let friendsLabel3: UILabel = {
        ...
        label.font = UIFont(font: .avenirNextDemiBold, size: 22)
        //        label.text = "Recommended by you & your friends anywhere you are"
        label.text = "Always find legit food your friends recommend wherever you are"
        label.textColor = UIColor.ianBlackColor()
        label.numberOfLines = 0
        label.lineBreakMode = NSLineBreakMode.byWordWrapping
        return label
    ...
    var mapScreenshotView: UIImageView = {
        let img = UIImageView()
        img.image = #imageLiteral(resourceName: "map_sample_screenshot").withRenderingMode(.alwaysOriginal)
...
//        let listView = UserWelcome2View()
    ...
    override func viewDidLoad() {
        ...
        let topGap = UIScreen.main.bounds.height > 750 ? 30 : 20
        let headerFontSize = UIScreen.main.bounds.height > 750 ? 30 : 25
        let detailFontSize = UIScreen.main.bounds.height > 750 ? 22 : 19
        
        self.view.addSubview(addListButton)
        addListButton.anchor(top: nil, left: view.leftAnchor, bottom: view.bottomAnchor, right: view.rightAnchor, paddingTop: 0, paddingLeft: 20, paddingBottom: 20, paddingRight: 40, width: 0, height: 50)
        ...
        hungryLabel.anchor(top: topLayoutGuide.bottomAnchor, left: view.leftAnchor, bottom: nil, right: nil, paddingTop: 20, paddingLeft: 15, paddingBottom: 0, paddingRight: 10, width: 0, height: 0)
        ...
        foodEmojiLabel.anchor(top: nil, left: nil, bottom: nil, right: nil, paddingTop: 10, paddingLeft: 0, paddingBottom: 0, paddingRight: 10, width: 0, height: 35)
        foodEmojiLabel.leftAnchor.constraint(lessThanOrEqualTo: hungryLabel.rightAnchor, constant: 5).isActive = true
        foodEmojiLabel.rightAnchor.constraint(lessThanOrEqualTo: view.rightAnchor).isActive = true
        foodEmojiLabel.centerYAnchor.constraint(equalTo: self.hungryLabel.centerYAnchor).isActive = true
        //        foodEmojiLabel.centerYAnchor.constraint(equalTo: hungryLabel.centerYAnchor).isActive = true
        foodEmojiLabel.font = UIFont(name: "Poppins-Bold", size: CGFloat(headerFontSize))
        ...
        friendsLabel.anchor(top: hungryLabel.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: CGFloat(topMargin), paddingLeft: 15, paddingBottom: 0, paddingRight: 15, width: 0, height: 0)
        ...
        self.view.addSubview(mapScreenshotView)
        mapScreenshotView.anchor(top: friendsLabel3.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 10, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
//        mapScreenshotView.heightAnchor.constraint(equalTo: mapScreenshotView.widthAnchor, multiplier: 1).isActive = true
        mapScreenshotView.backgroundColor = UIColor.clear
