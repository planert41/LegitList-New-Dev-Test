...
protocol InboxThreadCellDelegate {
    func refreshPost(post:Post)
    func didTapPicture(post:Post)
}

class InboxThreadCell: UICollectionViewCell {

    var delegate: InboxThreadCellDelegate?
...
class InboxMessageThreadTableViewCell: UITableViewCell {
