...
//        label.font = UIFont(font: .avenirBlack, size: 30)
    ...
    let infoText =
    """
    Check out what your friends have been recently eating on your home feed.

    Sort your feed by Nearest to see all the food your friends have tried nearby wherever you are.
    """
