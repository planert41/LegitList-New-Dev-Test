...
class NewUserOnboardView2: UIViewController {
...
//        let listView = UserWelcome2View()
        let listView = NewUserOnboardView3()
...
//        animateLabels()
    ...
    var infoImageView: UIImageView = {
        let img = UIImageView()
//        img.image = #imageLiteral(resourceName: "mapExample2").withRenderingMode(.alwaysOriginal)
        img.image = #imageLiteral(resourceName: "Example_search").withRenderingMode(.alwaysOriginal)
...
//    Remember all the food you tried on your last trip and share your recommendations
    ...
    @objc func handleBackButton(){
        ...
        let welcomeView = NewUserOnboardView1()
