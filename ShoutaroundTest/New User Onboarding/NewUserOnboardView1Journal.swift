...
//        label.font = UIFont(font: .avenirBlack, size: 30)
    ...
    let infoText =
    """
    Post your pictures with the location, personal rating, review and food emojis 🍔 .
    
    And if 5 stars isn't enough, tag a rating emoji.
    """
...
//        infoTextView.bottomAnchor.constraint(lessThanOrEqualTo: nextButton.topAnchor, constant: 10).isActive = true
        ...
        ratingEmojiCollectionView.anchor(top: infoTextView.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 5, paddingLeft: 15, paddingBottom: 0, paddingRight: 15, width: CGFloat(50 * extraRatingEmojis.count), height: 35)
